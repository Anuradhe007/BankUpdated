...
public class ReadTextFile {
    ...
    public List<String> getGiverInfo() {
        ...
        String fileName = Paths.get("database\\GiverInfo.txt").toString();
    ...
    public List<String> getRecieverInfo() {
        // The name of the file to open.
        String fileName = Paths.get("database\\RecieverInfo.txt").toString();
    ...
    public String getCustomerChosenAccount() {
        // The name of the file to open.
        String fileName = Paths.get("database\\SelectedAccount.txt").toString();
    ...
    public List<String> getParent1Info() {
        // The name of the file to open.
        String fileName = Paths.get("database\\Parent1Info.txt").toString();
    ...
    public List<String> getParent2Info() {
        // The name of the file to open.
        String fileName = Paths.get("database\\Parent2Info.txt").toString();
    ...
    public String getCustomerMessage() {
        // The name of the file to open.
        String fileName = Paths.get("database\\CustomerAnswer.txt").toString();
